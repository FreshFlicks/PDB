...
class music_cog(commands.Cog):
  ...
  @commands.command(name="resume", help="Resumes playing the current song.")
  ...
  @commands.command(name="disconnect", aliases=["d", "leave"] , help="Resumes playing the current song.")
